...
#define RAI_RGHT LT(_RAISE, KC_RGHT)
#define RAI_P0   LT(_RAISE, KC_P0)
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |  ⇥/^ | A/NAV|   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  | ;/NAV| Ret/⌃|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | (/⇧  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  )/⇧ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Lower| Spc/^|  ⌥   |   ⌘  | Lower| Bksp |Space |Raise |Left/⌘| Down |  Up  |->/Rai|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_BSPC,
  KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,
  CTL_TAB, NAV_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    NAV_SCLN, CTL_RET,
  KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSPC,
  LOWER,   CTL_SPC, KC_LALT, KC_LGUI, LOWER,   KC_BSPC, KC_SPC,  RAISE,   GUI_LEFT,KC_DOWN, KC_UP,    RAI_RGHT
),
 ...
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  |   Q  |   W  |   F  |   P  |   G  |   Y  |   U  |   I  |   K  |   ;  | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Tab/^| A/NAV|   R  |   S  |   T  |   D  |   H  |   N  |   E  |   L  | O/NAV| Ret/^|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   J  |   M  |   ,  |   .  |   /  | Ret/⇧|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Lower| Spc/^|  ⌥   |   ⌘  | Lower| Bksp |Space |Raise |Left/⌘| Down |  Up  |->/Rai|
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK2] = LAYOUT_preonic_grid( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
  _______, KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_Y,    KC_U,    KC_I,    KC_K,    KC_SCLN, _______,
  _______, NAV_A,   KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_L,    NAV_O,   _______,
  _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_J,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 * |      |   (  |   )  |   -  |   =  |  [   |   ]  |   1  |   2  |   3  | Enter|  \   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |Shift | Bksp |Space |0/Rai |   0  |   .  | Enter|  `   |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_preonic_grid( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_COMM, KC_DOT,  KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_MINS,
  _______, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_QUOT,
  _______, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_P1,   KC_P2,   KC_P3,   KC_PENT, KC_BSLS,
  _______, _______, _______, _______, KC_LSFT, KC_BSPC, KC_SPC,  RAI_P0,  KC_P0,   KC_PDOT, KC_PENT, KC_GRV
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, COLEMAK2,_______, _______, \
